	...
	$("#layers").fancytree({
	  source: [
		...
		{title: FANCYTREE_ITEMS.OBSERVER.title, key: FANCYTREE_ITEMS.OBSERVER.key, folder: true,   unselectable :true, children: [
		  ...
		  {title: '<a target="_blank" href="metadata/'+FANCYTREE_ITEMS.OBSERVER.GEMM.url+'" >'+FANCYTREE_ITEMS.OBSERVER.GEMM.title+'</a> (Download Only) <i><a title="Download CSV File" data-name="'+FANCYTREE_ITEMS.OBSERVER.GEMM.key+'" >CSV</a>, <a title="Download XLSX File" href="'+api_base_uri+'/api/v1/source/observer.gemm_fact/selection.xlsx'" >XLSX</a></i>', key: FANCYTREE_ITEMS.OBSERVER.GEMM.key, icon: false, unselectable :true},
