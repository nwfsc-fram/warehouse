...
//		  {title: 'Conf' +' <i><a  title="Download CSV File" data-name="conf" >Conf CSV</a></i>', key: 'conf', icon: false},
		...
		{title: FANCYTREE_ITEMS.SPATIAL_REFERENCES.title, key: FANCYTREE_ITEMS.SPATIAL_REFERENCES.key, folder: true,  children: [
   			{title: '<a target="_blank" title="'+FANCYTREE_ITEMS.SPATIAL_REFERENCES.GROUNDFISH_TRAWL_RCA_POLY_2017_2019.title+'" href="'+FANCYTREE_ITEMS.SPATIAL_REFERENCES.GROUNDFISH_TRAWL_RCA_POLY_2017_2019.url+'" >'+FANCYTREE_ITEMS.SPATIAL_REFERENCES.GROUNDFISH_TRAWL_RCA_POLY_2017_2019.title+'</a>', key: FANCYTREE_ITEMS.SPATIAL_REFERENCES.GROUNDFISH_TRAWL_RCA_POLY_2017_2019.key+1000, data:{/*layer:efhGeneralGroundfishTrawlPoly20152016MapLayer  , */url:FANCYTREE_ITEMS.SPATIAL_REFERENCES.GROUNDFISH_TRAWL_RCA_POLY_2017_2019.url, mapServices:FANCYTREE_ITEMS.SPATIAL_REFERENCES.GROUNDFISH_TRAWL_RCA_POLY_2017_2019.mapServices}, icon: false},
